...
// Validate signup OTP verification
const validateSignupOtpVerification = (req, res, next) => {
  ...
  if (!role || !['user', 'authority'].includes(role)) {
    errors.push('Role must be either user or authority');
  }
...
// Validate signup OTP resend
const validateSignupOtpResend = (req, res, next) => {
